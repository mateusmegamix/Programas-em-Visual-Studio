...
namespace Tictactoe
{
    public partial class JogoDaVelha : Form
    {
        ...
        private void cell1_Click(object sender, EventArgs e) 
        {
            ...
            myButton.Text = (Game.getAttacker() == Controladora.Player.X) ? "X" : "O";
            ...
            if (Game.HasWinner(Game.getBoard()))
            {
                ...
                {
                    xWin = (Game.getAttacker() == Controladora.Player.X) ? true : false;
                    if (xWin)
                    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                Game.setAttacker(Controladora.Player.O);
            }
            else
            {
                Game.setAttacker(Controladora.Player.X);
            }
            txtTurn.Text = Game.getAttacker().ToString() + " Jogou!";
        }
